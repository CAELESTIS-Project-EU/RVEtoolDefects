...
def writeAlyaSld3D(file, filename, dash_iload, kfl_timei, kfl_coh, nmate, iload, lx, ly, lz, debug,
    ...
    if iload == '11':
        ...
        stream.write('        1 & 2 100 1.0 0.0 0.0, DISCRETE_FUNCTIONS= F_UXX\n')
        ...
        stream.write('        4 & 2 010 0.0 1.0 0.0, DISCRETE_FUNCTIONS= F_UYY\n')
        stream.write('        5 & 2 010 0.0 1.0 0.0, DISCRETE_FUNCTIONS= F_UYY\n')        
        stream.write('        6 & 2 010 0.0 1.0 0.0, DISCRETE_FUNCTIONS= F_UYY\n')
        stream.write('    5 & 3 & 2 110 0.0 1.0 0.0, DISCRETE_FUNCTIONS= F_UYY\n')
        stream.write('    6 & 3 & 2 110 0.0 1.0 0.0, DISCRETE_FUNCTIONS= F_UYY\n')
        ...
        stream.write('        1 & 4 100 1.0 0.0 0.0, DISCRETE_FUNCTIONS= F_UXX\n')
        ...
        stream.write('        5 & 3 001 0.0 0.0 0.0\n')
        stream.write('        6 & 3 001 0.0 0.0 0.0\n')
        stream.write('    1 & 5 & 3 011 0.0 0.0 0.0\n')
        stream.write('    1 & 6 & 3 001 0.0 0.0 0.0\n')
        stream.write('    2 & 5 & 3 011 0.0 0.0 0.0\n')
        stream.write('    2 & 6 & 3 001 0.0 0.0 0.0\n')
        stream.write('            5 010 0.0 0.0 0.0\n')
        stream.write('        1 & 5 010 0.0 0.0 0.0\n')
        stream.write('        2 & 5 010 0.0 0.0 0.0\n')
        stream.write('        4 & 5 010 0.0 0.0 0.0\n')
        stream.write('    2 & 4 & 5 010 0.0 0.0 0.0\n')
        ...
        stream.write('        5 & 4 001 0.0 0.0 1.0, DISCRETE_FUNCTIONS= F_UZZ\n')
        stream.write('        6 & 4 011 0.0 1.0 1.0, DISCRETE_FUNCTIONS= F_UYZ\n')
        stream.write('    1 & 5 & 4 001 0.0 0.0 1.0, DISCRETE_FUNCTIONS= F_UZZ\n')
        stream.write('    1 & 6 & 4 011 0.0 1.0 1.0, DISCRETE_FUNCTIONS= F_UYZ\n')
        stream.write('    2 & 5 & 4 001 0.0 0.0 1.0, DISCRETE_FUNCTIONS= F_UZZ\n')
        stream.write('    2 & 6 & 4 011 0.0 1.0 1.0, DISCRETE_FUNCTIONS= F_UYZ\n')
