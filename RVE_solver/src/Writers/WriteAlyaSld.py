...
def writeAlyaSld2D(file, filename, dash_iload, kfl_timei, kfl_coh, nmate, iload, lx, ly, lz, debug,
    ...
    if iload == '11':
        ...
        stream.write('            2 11 1.0 0.0, DISCRETE_FUNCTIONS= F_UX \n')
        stream.write('        2 & 3 11 1.0 0.0, DISCRETE_FUNCTIONS= F_UX \n')
        stream.write('        2 & 4 11 1.0 0.0, DISCRETE_FUNCTIONS= F_UX \n')
        ...
        stream.write('        1 & 3 11 0.0 0.0 \n')
        stream.write('        1 & 4 11 0.0 1.0, DISCRETE_FUNCTIONS= F_UY \n')
        stream.write('            2 10 0.0 0.0 \n')
        stream.write('        2 & 3 11 0.0 0.0 \n')
        stream.write('        2 & 4 11 0.0 1.0, DISCRETE_FUNCTIONS= F_UY \n')
        stream.write('            3 11 0.0 0.0 \n')
        stream.write('            4 11 0.0 1.0, DISCRETE_FUNCTIONS= F_UY \n')
    elif iload == '12':
        # In-plane shear
        stream.write('            1 01 0.0 0.0 \n')
        stream.write('        1 & 3 11 0.0 0.0 \n')
        stream.write('        1 & 4 11 1.0 0.0, DISCRETE_FUNCTIONS= F_UX \n')
        stream.write('            2 01 0.0 1.0, DISCRETE_FUNCTIONS= F_UY \n')
        stream.write('        2 & 3 11 0.0 1.0, DISCRETE_FUNCTIONS= F_UY \n')
        stream.write('        2 & 4 11 1.0 1.0, DISCRETE_FUNCTIONS= F_UXY \n')
        stream.write('            3 10 0.0 0.0 \n')
        stream.write('            4 10 1.0 0.0, DISCRETE_FUNCTIONS= F_UX \n')
...
def writeAlyaSld3D(file, filename, dash_iload, kfl_timei, kfl_coh, nmate, iload, lx, ly, lz, debug,
    ...
    if iload == '11':
        ...
        stream.write('            6 001 0.0 0.0 1.0, DISCRETE_FUNCTIONS= F_UZ \n')
        stream.write('        1 & 6 001 0.0 0.0 1.0, DISCRETE_FUNCTIONS= F_UZ \n')
        stream.write('        2 & 6 001 0.0 0.0 1.0, DISCRETE_FUNCTIONS= F_UZ \n')
        stream.write('        3 & 6 001 0.0 0.0 1.0, DISCRETE_FUNCTIONS= F_UZ \n')
        stream.write('        4 & 6 001 0.0 0.0 1.0, DISCRETE_FUNCTIONS= F_UZ \n')
        stream.write('    1 & 3 & 6 001 0.0 0.0 1.0, DISCRETE_FUNCTIONS= F_UZ \n')
        stream.write('    1 & 4 & 6 001 0.0 0.0 1.0, DISCRETE_FUNCTIONS= F_UZ \n')
        stream.write('    2 & 3 & 6 001 0.0 0.0 1.0, DISCRETE_FUNCTIONS= F_UZ \n')
        stream.write('    2 & 4 & 6 001 0.0 0.0 1.0, DISCRETE_FUNCTIONS= F_UZ \n')
    elif iload == '22':
        ...
        stream.write('            4 010 0.0 1.0 0.0, DISCRETE_FUNCTIONS= F_UY \n')
        stream.write('        1 & 4 010 0.0 1.0 0.0, DISCRETE_FUNCTIONS= F_UY \n')
        stream.write('        2 & 4 010 0.0 1.0 0.0, DISCRETE_FUNCTIONS= F_UY \n')
        stream.write('        5 & 4 010 0.0 1.0 0.0, DISCRETE_FUNCTIONS= F_UY \n')
        stream.write('        6 & 4 010 0.0 1.0 0.0, DISCRETE_FUNCTIONS= F_UY \n')
        stream.write('    1 & 5 & 4 010 0.0 1.0 0.0, DISCRETE_FUNCTIONS= F_UY \n')
        stream.write('    1 & 6 & 4 010 0.0 1.0 0.0, DISCRETE_FUNCTIONS= F_UY \n')
        stream.write('    2 & 5 & 4 010 0.0 1.0 0.0, DISCRETE_FUNCTIONS= F_UY \n')
        stream.write('    2 & 6 & 4 010 0.0 1.0 0.0, DISCRETE_FUNCTIONS= F_UY \n')
    elif iload == '33':
        ...
        stream.write('            2 100 1.0 0.0 0.0, DISCRETE_FUNCTIONS= F_UX \n')
        stream.write('        1 & 2 100 1.0 0.0 0.0, DISCRETE_FUNCTIONS= F_UX \n')
        stream.write('        4 & 2 100 1.0 0.0 0.0, DISCRETE_FUNCTIONS= F_UX \n')
        stream.write('        5 & 2 100 1.0 0.0 0.0, DISCRETE_FUNCTIONS= F_UX \n')
        stream.write('        6 & 2 100 1.0 0.0 0.0, DISCRETE_FUNCTIONS= F_UX \n')
        stream.write('    3 & 5 & 2 100 1.0 0.0 0.0, DISCRETE_FUNCTIONS= F_UX \n')
        stream.write('    3 & 6 & 2 100 1.0 0.0 0.0, DISCRETE_FUNCTIONS= F_UX \n')
        stream.write('    4 & 5 & 2 100 1.0 0.0 0.0, DISCRETE_FUNCTIONS= F_UX \n')
        stream.write('    4 & 6 & 2 100 1.0 0.0 0.0, DISCRETE_FUNCTIONS= F_UX \n')
    elif iload == '12':
        # In-plane pure shear XY
        stream.write('            1 010 0.0 0.0 0.0 \n')
        stream.write('        3 & 1 010 0.0 0.0 0.0 \n')
        stream.write('        4 & 1 010 0.0 0.0 0.0 \n')
        stream.write('        5 & 1 010 0.0 0.0 0.0 \n')
        stream.write('        6 & 1 010 0.0 0.0 0.0 \n')        
        stream.write('    5 & 3 & 1 110 0.0 0.0 0.0 \n')
        stream.write('    5 & 4 & 1 010 0.0 0.0 0.0 \n')
        stream.write('    6 & 3 & 1 010 0.0 0.0 0.0 \n')
        stream.write('    6 & 4 & 1 110 0.0 0.0 0.0 \n')
        ...
        stream.write('            2 010 0.0 1.0 0.0, DISCRETE_FUNCTIONS= F_UY \n')
        stream.write('        3 & 2 110 0.0 1.0 0.0, DISCRETE_FUNCTIONS= F_UY \n')
        stream.write('        4 & 2 010 0.0 1.0 0.0, DISCRETE_FUNCTIONS= F_UY \n')
        stream.write('        5 & 2 010 0.0 1.0 0.0, DISCRETE_FUNCTIONS= F_UY \n')        
        stream.write('        6 & 2 010 0.0 1.0 0.0, DISCRETE_FUNCTIONS= F_UY \n')
        stream.write('    5 & 3 & 2 110 0.0 1.0 0.0, DISCRETE_FUNCTIONS= F_UY \n')
        stream.write('    6 & 3 & 2 110 0.0 1.0 0.0, DISCRETE_FUNCTIONS= F_UY \n')
        stream.write('    5 & 4 & 2 110 1.0 1.0 0.0, DISCRETE_FUNCTIONS= F_UXY \n')
        stream.write('    6 & 4 & 2 110 1.0 1.0 0.0, DISCRETE_FUNCTIONS= F_UXY \n')
        stream.write('            4 100 1.0 0.0 0.0, DISCRETE_FUNCTIONS= F_UX \n')
        stream.write('        1 & 4 100 1.0 0.0 0.0, DISCRETE_FUNCTIONS= F_UX \n')
        stream.write('        2 & 4 110 1.0 1.0 0.0, DISCRETE_FUNCTIONS= F_UXY \n')
        stream.write('        5 & 4 100 1.0 0.0 0.0, DISCRETE_FUNCTIONS= F_UX \n')
        stream.write('        6 & 4 100 1.0 0.0 0.0, DISCRETE_FUNCTIONS= F_UX \n')
    elif iload == '23':
        # Transverse shear
        stream.write('            3 100 0.0 0.0 0.0 \n')
        stream.write('        1 & 3 100 0.0 0.0 0.0 \n')
