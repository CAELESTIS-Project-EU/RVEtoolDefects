...
-->
RVEtool is a modeling package for generating, meshing and running finite element based micromechanical models based on fiber-reinforced materials including the presence of defects. The different packages are devised to run in High-Performance Computing environments.
...
## Usage
The repository contains a main file `RVEtool.py` wich loads a `yaml` file containing all the user inputs.
